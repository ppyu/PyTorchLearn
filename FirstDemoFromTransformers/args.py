...
def add_common_args(parser):
    ...
    parser.add_argument("--custom_model", default='bert_base', type=str, required=True,
                        help="Squad model selected in the list: bert_base, bert_linear, bert_deep, bert_qanet")
    ## Other parameters
